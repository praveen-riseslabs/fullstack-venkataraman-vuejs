...
<div class="input-box" >
   ...
   <input type="password" id="confirmpassword" name="confirmpassword" autocomplete="new-password" placeholder="confirm password" v-model.trim="confirmpassword" @blur="validateConfirmPassword">
