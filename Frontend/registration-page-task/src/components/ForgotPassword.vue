      ...
      <form @submit.prevent="submitDetails" class="form">
        ...
        <div class="column">
          ...
          <div class="input-box">
            ...
            <input type="text" id="email" name="email" autocomplete="email" placeholder="Enter your email"
              v-model.trim="email" @blur="validateUsername">
        ...
        <div>
          ...
          <p v-if="validateEmailInput === 'invalid' || validateSubmit === 'invalid'">Please check all fields properly
          </p>
